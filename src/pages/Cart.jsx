        ...
        <section className='px-auto py-12 min-h-screen'>
            ...
            <div className='mt-10 grid lg:grid-cols-3 gap-10'>
                        ...
                        <div key={item._id} className="flex gap-4 p-4 border border-black/10 rounded-2xl bg-white">
                            ...
                            <div className="flex-1 flex flex-col gap-2 min-w-0">
                                <div className="flex items-start justify-between gap-2">
                                    ...
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-trash" aria-hidden="true"><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"></path><path d="M3 6h18"></path><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg>
                                    </button>
                                </div>
                ...
                <div className='lg:sticky lg:top-24 self-start bg-black/3 rounded-2xl p-8 flex flex-col gap-5'>
                    ...
                    <div className="flex items-center justify-center gap-2 text-xs text-black/40"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-shield-check" aria-hidden="true"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"></path><path d="m9 12 2 2 4-4"></path></svg> Secure &amp; encrypted checkout</div>
                </div>
            </div>
        </section>
    )
